...
Generated by Agentic-Senior-Core CLI v3.0.31
Timestamp: 2026-04-26T07:44:31.757Z
...
Conceptual Anchor: Forensic Light Table
Anchor Reference: Forensic document light table with vellum overlays, registration rulers, edge clamps, and UV-reactive fibers
Signature Move: MISSING - define one concrete authored move before UI implementation
Motion Signature: A slow oblique inspection-light sweep crosses specimen surfaces while evidence sheets lift 3px on interaction and status stamps settle into place.
Typographic Decision: Condensed technical display headings contrast with readable civic body copy and monospaced microprint proof values.
