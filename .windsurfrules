...
Timestamp: 2026-04-25T12:46:41.073Z
...
Conceptual Anchor: Civic Signal Observatory
Anchor Reference: MISSING - required for deterministic token validation
Signature Move: MISSING - define one concrete authored move before UI implementation
Motion Signature: MISSING - define timing/easing/choreography before UI implementation
Typographic Decision: MISSING - define role contrast before UI implementation
