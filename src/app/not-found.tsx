...
export default function NotFoundPage(): JSX.Element {
  return (
    <main className="page-shell page-shell-not-found">
      ...
      <section className="not-found-frame register-surface register-surface-strong reveal-surface">
        <span className="register-tab">Record not found</span>
        <h1 className="hero-title hero-title-compact">No public serial register matches that code.</h1>
